...
class AgendaRepository
{
    ...
    public function insertUser($dados){
        $consultaInsert = 'INSERT INTO ' . self::TABELA . ' (id_funcionario, id_usuario,nm_usuario, data_hora, id_servico,valor) VALUES (:id_funcionario, :id_usuario,:nm_usuario,:data_hora,:id_servico,:valor)';
